...
class PopupBase {
  ...
  setupIframeEvent() {
    this._iframe.on('load', e => this.bindEvents(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(e.target.contentDocument)));
  }
  ...
  show() {
    ...
    this._view.detach();
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("body").append(this._view);
    this._view.fadeIn();
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_mainPage_js__ = __webpack_require__(4);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
  window.mainPage = new __WEBPACK_IMPORTED_MODULE_1__pages_mainPage_js__["a" /* default */](__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.root'), DUMMY_DATA);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_storeThumbnail__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_hexagonPopup__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_panotour__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_popup__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__slideShowTemplate__ = __webpack_require__(10);
...
class MainPage {
  constructor(root, storeArray) {
    ...
    const view = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(HTML);
  ...
  addStoreThumbnails(container, storeArray) {
    for (let index in storeArray) {
      ...
      const thumbnail = new __WEBPACK_IMPORTED_MODULE_1__components_storeThumbnail__["a" /* default */](container, store);
  ...
  showDetails(param, showTeam) {
    ...
    if (this._popup == null) {
      this._popup = new __WEBPACK_IMPORTED_MODULE_4__components_popup__["a" /* default */]();
    ...
    if (showTeam) {
      ...
      this._popup.setIframeContent(Object(__WEBPACK_IMPORTED_MODULE_5__slideShowTemplate__["a" /* default */])(slideShowContent));
    }
  ...
  showHexagonPanotour(store) {
    if (this._hexagonPopup == null) {
      this._hexagonPopup = new __WEBPACK_IMPORTED_MODULE_2__components_hexagonPopup__["a" /* default */]();
  ...
  showPanotour() {
    if (this._panotour == null) {
      this._panotour = new __WEBPACK_IMPORTED_MODULE_3__components_panotour__["a" /* default */]();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = StoreThumbnail;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__popupBase_js__ = __webpack_require__(1);
...
class HexagonPopup extends __WEBPACK_IMPORTED_MODULE_1__popupBase_js__["a" /* default */] {
  constructor() {
    super();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = HexagonPopup;
...
class Panotour extends __WEBPACK_IMPORTED_MODULE_1__popupBase_js__["a" /* default */] {
  constructor() {
    super();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Panotour;
...
class Popup extends __WEBPACK_IMPORTED_MODULE_1__popupBase_js__["a" /* default */] {
  constructor() {
    super();
...
<body style="padding:0px; margin:0px; background-color:#000;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
    ...
    <script src="scripts/lib/jssor.slider-26.5.2.min.js" type="text/javascript"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1280px;height:800px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img class='loading-spin' style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="slideshow/img/spin.svg" />
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1280px;height:700px;overflow:hidden;">
        ${content}
            <!--div>
                <img data-u="image" src="slideshow/img/031.jpg" />
                <img data-u="thumb" src="slideshow/img/031-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/032.jpg" />
                <img data-u="thumb" src="slideshow/img/032-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/033.jpg" />
                <img data-u="thumb" src="slideshow/img/033-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/034.jpg" />
                <img data-u="thumb" src="slideshow/img/034-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/035.jpg" />
                <img data-u="thumb" src="slideshow/img/035-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/036.jpg" />
                <img data-u="thumb" src="slideshow/img/036-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/037.jpg" />
                <img data-u="thumb" src="slideshow/img/037-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/038.jpg" />
                <img data-u="thumb" src="slideshow/img/038-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/039.jpg" />
                <img data-u="thumb" src="slideshow/img/039-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="slideshow/img/040.jpg" />
                <img data-u="thumb" src="slideshow/img/040-s190x90.jpg" />
            </div-->
        </div>
        <!-- Thumbnail Navigator -->
        ...
        <!-- Arrow Navigator -->
        <div data-u="arrowleft" class="jssora106" style="width:55px;height:55px;top:310px;left:30px;" data-scale="0.75">
        ...
        <div data-u="arrowright" class="jssora106" style="width:55px;height:55px;top:310px;right:30px;" data-scale="0.75">
            <svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                <circle class="c" cx="8000" cy="8000" r="6260.9"></circle>
